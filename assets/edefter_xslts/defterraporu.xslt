						...
						<div style="border-color:#1e1e1e; border-style:solid; border-width:10px; padding:20px; ">
							...
							<h1 style="font-size:20px; text-align:center; ">
								<span style="font-family:Arial Narrow; ">
									<xsl:text>BERAT (DEFTER RAPORU)</xsl:text>
								</span>
							</h1>
									...
									<div>
										...
										<div>
											<table border="0" cellpadding="5" cellspacing="0" width="100%">
												<tbody>
													<tr>
														<xsl:for-each select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entityInformation/gl-bus:accountantInformation">
														...
														<td>
															<span>
																<xsl:choose>
																	...
																	<xsl:when test="gl-cor:entriesType='trialbalance'">
																		<xsl:text>Berat (Defter Raporu)</xsl:text>
																	</xsl:when>
																	<xsl:otherwise>
							...
							<p>
								<xsl:if test="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
									<div style="font-size:8pt; margin-bottom:1px; margin-top:10px; padding:5px; text-align:center; ">
										<div style="font-size:8pt; margin-bottom:1px; margin-top:10px; padding:5px; text-align:center; ">
											<xsl:call-template name="Başlık">
												<xsl:with-param name="header" select="&quot;HESAP DETAYI&quot;"/>
											</xsl:call-template>
										</div>
										<table align="center" style="font-size:12pt">
											<tbody>
												<tr>
													...
													<td colspan="4" style="border:solid #000000 1px; padding: 5px;">
														<b>DÖNEM İÇİ DEĞİŞİKLİKLER</b>
													</td>
												</tr>
												<tr>
													<td style="border:solid #000000 1px; padding: 5px;">
														<b> BORÇ İŞLEM SAYISI</b>
													</td>
													<td style="border:solid #000000 1px; padding: 5px;">
														<b> BORÇ TUTARI</b>
													</td>
													<td style="border:solid #000000 1px; padding: 5px;">
														<b> ALACAK İŞLEM SAYISI</b>
													</td>
													<td style="border:solid #000000 1px; padding: 5px;">
														<b> ALACAK TUTARI</b>
													</td>
												</tr>
												<xsl:for-each select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
													<xsl:for-each select="gl-cor:entryDetail[gl-cor:xbrlInfo/gl-cor:xbrlInclude='period_change' and gl-cor:debitCreditCode='D']">
														<tr>
															...
															<td style="border:solid #000000 1px; padding: 5px;">
																<xsl:variable name="amountd" select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=$hesapKodu and gl-cor:debitCreditCode='D']/gl-cor:amount"/>
																<xsl:value-of select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=$hesapKodu and gl-cor:debitCreditCode='D']/gl-cor:documentApplyToNumber"/>
															</td>
															<td style="border:solid #000000 1px; padding: 5px;">
																<xsl:variable name="amountd" select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=$hesapKodu and gl-cor:debitCreditCode='D']/gl-cor:amount"/>
																<xsl:if test="$amountd">
															...
															<td style="border:solid #000000 1px; padding: 5px;">
																<xsl:variable name="amountd" select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=$hesapKodu and gl-cor:debitCreditCode='C']/gl-cor:amount"/>
																<xsl:value-of select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=$hesapKodu and gl-cor:debitCreditCode='C']/gl-cor:documentApplyToNumber"/>
															</td>
															<td style="border:solid #000000 1px; padding: 5px;">
																<xsl:variable name="amountc" select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=$hesapKodu and gl-cor:debitCreditCode='C']/gl-cor:amount"/>
																<xsl:if test="$amountc">
